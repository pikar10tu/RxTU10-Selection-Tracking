...
### 2. 🛒 ออเดอร์รายวัน — ⏭️ ถัดไป (ยังไม่ brainstorm)
บอร์ดออเดอร์สุ่มรายวัน ส่งพืชตามสั่ง → รางวัลก้อน · จูงใจให้ปลูกหลากหลายแทนสแปมพืชคุ้มสุดตัวเดียว · ต่อกับ `dailyQuest` เดิมได้
