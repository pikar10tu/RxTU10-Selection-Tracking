// ════════════════════════════════════════════════════════════
//  questionTriage — จัดกองงานค้างของทีมวิชาการ (pure ทั้งไฟล์)
//  คิดจาก list ที่ QuestionsView โหลดมาแล้ว ⇒ ไม่เปลือง Firestore read เพิ่มเลย
//
...
export const BUCKET_META = {
  ...
  nogroup: {
    ...
    hint: 'ยังไม่ได้จัดเข้ากลุ่มตามเกณฑ์สภาฯ — เปิดแก้แล้วเลือกกลุ่มให้',
  },
}
...
// สรุปตัวเลขไว้โชว์บนหัวแท็บ/แถบรวม
