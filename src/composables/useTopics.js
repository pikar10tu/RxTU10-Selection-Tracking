// รายชื่อหมวด/หัวข้อข้อสอบเวอร์ชันเก่า (config/topics.list) — free text ที่วิชาการเพิ่มกันเอง
// ⚠️ **เลิกใช้เป็นทะเบียนหลักแล้ว 29 ส.ค. 2026** — หมวดจริงย้ายไป data/plecc.js (ตายตัว ตามเกณฑ์สภาฯ)
//    เพราะทะเบียนที่โตเองงอกเป็น 82 หมวดซ้ำซ้อน · TopicSelect ไม่อ่านไฟล์นี้อีกต่อไป
//    เหลือไว้ให้กล่อง "จัดการหมวด" ใน QuestionsView ใช้กวาดซากเก่า + bulk import (ยังไม่ย้าย = P2)
