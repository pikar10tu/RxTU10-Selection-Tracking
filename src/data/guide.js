...
export const GUIDE = {
  ...
  tower: {
    ...
    body: [
      'จัดทีมสัตว์เลี้ยง (Active) แล้วท้าสู้บอทไต่ทีละชั้น ยิ่งขึ้นสูงยิ่งได้โบนัสรายได้ต่อวันเพิ่ม จนเต็มเพดานที่ชั้น 70 (ชั้นถัดไปไม่เพิ่มโบนัสแล้ว แต่ยังไต่ต่อวัดฝีมือได้)',
  ...
  arena: {
    ...
    body: [
      'เอาทีมต่อสู้ 3 ตัวไปบุกทีมที่เพื่อนในรุ่นจัดไว้ เก็บแต้มสะสม (ไม่ต้องรอเขาออนไลน์)',
