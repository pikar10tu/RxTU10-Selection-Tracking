...
export const STATUS_ICON = {
  ...
  // ── P2c-1 Task 5 ──
  // 💪 ยังไม่มีใครใช้ในทะเบียนนี้ (เช็คแล้ว 5 ก.ย.) — ไม่ใช่ 🧿 ของกลุ่มกันตาย (revive/saveAlly/cheatDeath)
  //    เพราะ grit เป็น "สถานะทนที่ค้างอยู่ระหว่างไฟต์" ไม่ใช่ "เหตุการณ์กันตายครั้งเดียว" คนละความหมายกัน
  grit: '💪',
}
...
export const STATUS_TEXT = {
  ...
  // ── P2c-1 Task 5 ──
  grit: 'ทนหมัดถึงตายได้อีก พลังโจมตีเพิ่มระหว่างมีสถานะ',
}
...
export const SELF_STATUS_EFFECTS = new Set([
  ...
  'taunt', 'armorStack',
  // ── P2c-1 Task 5 ── grit เป็นสถานะติดตัวเจ้าของ (แมว) เอง ไม่ใช่ aura/ดีบัฟที่ลงบนใครอื่น
  'grit',
])
