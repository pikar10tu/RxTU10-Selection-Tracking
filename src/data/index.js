...
import { PET_PASSIVES } from './petPassives.js'
 ...
 *    ตั้งแต่ 28 ส.ค. 2026 **ทุกหมัดจริงขยับการ์ดหมด** (ยกเว้นหมัดลูกที่อยู่ในหมัดหลักอยู่แล้ว)
 *    เพราะ user สั่งว่า "อยากให้การ์ดทุกอันขยับพอๆ กันในการโจมตีแต่ละที"
 *    งบเวลาอยู่ที่ BEAT ใน utils/battleBeats.js ที่เดียว (ไม่มีตารางชั้นแล้ว)
...
// passive signature — data อยู่ที่ data/petPassives.js (แยกไฟล์เพราะยาวและแก้บ่อยกว่าแค็ตตาล็อก)
// รับได้ทั้ง def จาก catalog และ instance ที่มี id (ใช้ id เป็นกุญแจอย่างเดียว)
export function passiveOf(def){ return PET_PASSIVES[def?.id] || null; }
...
// tunable pin: ปรับที่นี่ที่เดียว · ไม่มีเพดานรายวันแล้ว (ทำมากได้มาก)
